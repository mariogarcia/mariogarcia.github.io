...
some years ago a
https://github.com/bsideup/groovy-pattern-match/blob/master/src/test/groovy/ru/trylogic/groovy/pattern/PatternMatchingMacroMethodsTest.groovy[library]
bringing pattern matching to Groovy. I strongly recommend to check it
out.

...
== Intro
Yesterday I talked to my dear friend
...
matching module and Groovy's switch case when my Groovy instinct made
me realise how underated Groovy's switch-case statement is. Let me
show you my point.  Lets say we have the `Person` type:
...
Lets see how I built the patterns I used:

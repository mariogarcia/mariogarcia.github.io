...
[source, ruby]
./kubernetes_installation/master/Vagrantfile
----
include::{sources}/master/Vagrantfile[indent=0]
----

[source, ruby]
./kubernetes_installation/slave/Vagrantfile
----
include::{sources}/slave/Vagrantfile[indent=0]
----

The most important thing here is to be aware of the IPs because we'll
need them afterwards when creating the Kubernetes cluster.
...
.playbook
----
include::{sources}/master/playbook.yml[indent=0]
----

The playbook only points at the role containing the tasks to be
applied:

[source, yaml]
.roles/base/tasks/main.yml
----
include::{sources}/master/roles/base/tasks/main.yml[indent=0]
----
...
machine, in your host, go to `master` directory and execute:

[source, shell]
.master
----
/home/mario/kubernetes_installation/master@mario> vagrant up
----
...
.slave
----
/home/mario/kubernetes_installation/slave@mario> vagrant up
----
...
.vagrant ssh
----
/home/mario/kubernetes_installation/master@mario> vagrant ssh
----
...
But because we're using a specific IP we'd like to set the master IP
and
...
The command output will give us a couple of interesting things. First
how to use kubectl withouth being root:
...
NOTE: This is based on Calico Pod network documentation:
...
[source, shell]
----
vagrant@kubmaster:~$ watch kubectl get pods --all-namespaces
----
...
[source, shell]
----
/home/mario/kubernetes_installation/slave@mario> vagrant ssh
----
...
[source, shell]
----
vagrant@kubslave:~$ sudo kubeadm join 192.168.250.38:6443 --token uvdk4i.7ie6cil14w722gf5 --discovery-token-ca-cert-hash sha256:ea60fce4ffcc2b928e9f505f5ba84eb8d5151048eafb655cf1b4bd60fa009fce
----
...
kubmaster   Ready     master    19h       v1.10.2   <none>        Debian GNU/Linux 9 (stretch)   4.9.0-6-amd64    docker://18.3.1
kubslave    Ready     <none>    19h       v1.10.2   <none>        Debian GNU/Linux 9 (stretch)   4.9.0-6-amd64    docker://18.3.1
----

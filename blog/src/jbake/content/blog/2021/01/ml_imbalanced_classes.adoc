...
image::2021/01/ml_imbalanced_classes/imbalanced_01.png[alt="Cancer cells"]
...
WARNING: You may be wondering (I did)... if the majority class is 73% of the samples, then **Why the dummy classifier is not getting 73% of accuracy ?** Because we're splitting the samples into training and test sets, and that changes the percentages, lowering them.
